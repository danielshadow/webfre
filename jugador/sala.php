...
// Obtener el ID de la sala desde el parámetro de la URL
$id_sala = $_GET['id'];
...
// Verificar si el usuario está registrado en la sala
...
if (!$is_registered) {
    // El usuario no está registrado en la sala
...
// Consulta SQL para obtener los ID de los usuarios presentes en la sala, excluyendo al usuario actual
...
// Consulta SQL para obtener las armas disponibles que tengan menos o igual puntos que el usuario actual
...
// Verificar y eliminar usuarios con vida <= 0 o id_puntos diferente al del mundo
$eliminados = [];
...
<head>
    ...
    <script>
        window.onload = function() {
            // Ocultar el div de selección de arma y el botón de atacar al cargar la página
            ...
            var contadorTiempo = setInterval(function() {
                ...
                if (tiempoRestante <= 0) {
                    ...
                    window.location.href = "jugaro.php";
                }
            }, 1000);
